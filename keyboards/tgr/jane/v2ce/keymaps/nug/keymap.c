...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_L0] = LAYOUT_tkl_f13_ansi_tsangan_split_rshift(
  ...
  [_L1] = LAYOUT_tkl_f13_ansi_tsangan_split_rshift(
  ...
  [_L2] = LAYOUT_tkl_f13_ansi_tsangan_split_rshift(
  ...
  [_L3] = LAYOUT_tkl_f13_ansi_tsangan_split_rshift(
...
void keyboard_pre_init_user(void) {
  setPinOutput(D1); // caps
  setPinOutput(D6); // scroll
}
