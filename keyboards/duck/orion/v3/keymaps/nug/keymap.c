#include QMK_KEYBOARD_H // Layout for Duck Orion v2.5
...
[_L0] = LAYOUT_tkl_ansi(
  KC_ESC,   BL_ON,   BL_UP,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,           KC_PSCR, KC_SCRL, KC_PAUS, 
  ...
  KC_LSFT,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, RSFT_UA, LT_L1DE,                   KC_UP,        
...
[_L1] = LAYOUT_tkl_ansi(
  ...
  QK_GESC,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_DEL,  KC_INS,  KC_HOME, KC_PGUP, 
  KC_CAPS,  KC_PGUP, KC_UP,   KC_PGDN, _______, _______, _______, _______, KC_PGUP, _______, _______, KC_LBRC, KC_RBRC, KC_INS,  KC_DEL,  KC_END,  KC_PGDN, 
  _______,  KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, _______, KC_HOME, KC_PGDN, KC_END,  _______, _______,          KC_PSCR,                          
  _______,  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_PGUP, _______,                   KC_PGUP,        
...
[_L3] = LAYOUT_tkl_ansi(
  QK_BOOT,  BL_TOGG, BL_STEP, BL_UP,   BL_DOWN, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,            KC_NO,   KC_NO,   KC_NO, 
  KC_NO,    RGB_TOG, RGB_MOD, RGB_HUI, RGB_SAI, RGB_VAI, RGB_SPI, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO, 
  KC_NO,    KC_NO,   RGB_RMOD,RGB_HUD, RGB_SAD, RGB_VAD, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO, 
...
void keyboard_pre_init_user(void) {
  setPinOutput(B4); // num (top)
  setPinOutput(B0); // caps (middle)
  setPinOutput(D7); // scroll (bottom)
}
