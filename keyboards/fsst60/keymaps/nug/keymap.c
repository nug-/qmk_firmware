...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_L0] = LAYOUT(
		...
		KC_LCTL,  KC_LGUI, KC_LALT, 					                 LT_L1SP,  											              RALT_LA, RGUI_DA, RCTL_RA),

	[_L1] = LAYOUT(
		KC_GRV,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_DEL,  KC_DEL,
		KC_CAPS,  KC_PGUP, KC_UP,   KC_PGDN, KC_R,    KC_T,    KC_Y,    KC_U,    KC_PGUP, KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_INS,
		_______,  KC_LEFT, KC_DOWN, KC_RGHT, KC_F,    KC_G,    KC_H,    KC_HOME, KC_PGDN, KC_END,  KC_SCLN, KC_QUOT, KC_PSCR, KC_NO,
		KC_LSFT,  KC_NO,   KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_PGUP, _______,
		KC_LCTL,  KC_LGUI, KC_LALT, 					                 _______,  											              KC_HOME, KC_PGDN, KC_END),
	...
	[_L2] = LAYOUT(
		...
		KC_LCTL,  KC_NO,   KC_LALT, 					                 KC_SPC,  											              KC_LEFT, KC_DOWN, KC_RGHT),
