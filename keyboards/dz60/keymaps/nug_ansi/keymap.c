 ...
 */
  ...
  [_L2] = LAYOUT(
    ...
    KC_LCTL,   KC_NO, KC_LALT,  KC_SPC,  KC_SPC,  KC_SPC,   TG_L2, KC_LEFT, KC_DOWN, KC_DOWN, KC_RGHT),
  ...
  [_L3] = LAYOUT(
      ...
      KC_NO, BL_TOGG, BL_STEP,  BL_INC,  BL_DEC,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,
