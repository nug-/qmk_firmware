 ...
 * ├────┬───┴┬──┴─┬─┴───┴───┴───┴───┴───┴──┬┴───┼───┴┬────┬┴───┤
 * │CTL │GUI │ALT │     SPACE (6.25u)      │MENU│ALT │GUI │CTL │
 * └────┴────┴────┴────────────────────────┴────┴────┴────┴────┘
 */
  ...
  [_L0] = LAYOUT(
   ...
   TD(TCAP),    KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L, KC_SCLN, KC_QUOT,  KC_ENT,
    ...
    KC_LCTL, KC_LGUI, KC_LALT, LT_L1SP, LT_L1SP, LT_L1SP,   TG_L2, RALT_LA, RGUI_DA, RGUI_DA, RCTL_RA),

  [_L1] = LAYOUT(
     KC_GRV,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11,  KC_F12,  ______,  KC_DEL,
     KC_CAPS, ______,   KC_UP,  ______,  ______,  ______,  ______,  ______, KC_PGUP,  ______,  ______,  ______,  ______,  KC_INS,
     ______, KC_LEFT, KC_DOWN, KC_RGHT,  ______,  ______,  ______, KC_HOME, KC_PGDN,  KC_END,  ______,  ______,  ______,
     ______,  ______,  ______,  ______,  ______,  ______,  ______,  ______,  ______,  ______,  ______,  ______, KC_PGUP,  ______,
     ______,  ______,  ______,  ______,  ______,  ______,  ______, KC_HOME, KC_PGDN, KC_PGDN,  KC_END),
  ...
  [_L2] = LAYOUT(
    ...
    KC_LCTL,   KC_NO, KC_LALT,  KC_SPC,  KC_SPC,  KC_SPC,   ______, KC_LEFT, KC_DOWN, KC_DOWN, KC_RGHT),
