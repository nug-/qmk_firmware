...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_L0] = LAYOUT(
    ...
    KC_LGUI,  KC_LALT, KC_LCTL,                            LT_L1SP,                            RALT_LA, RALT_LA, RGUI_DA, RCTL_RA),
  ...
  [_L1] = LAYOUT(
    ...
    _______,  KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, _______, KC_HOME, KC_PGDN, KC_END,  KC_SCLN, KC_QUOT,          KC_PSCR,
  ...
  [_L2] = LAYOUT(
    ...
    KC_LGUI,  KC_LALT, KC_LCTL,                            KC_SPC,                             KC_LEFT, KC_LEFT, KC_DOWN, KC_RGHT),
