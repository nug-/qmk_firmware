...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_L0] = LAYOUT(
    QK_GESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,     KC_0,     KC_MINS,  KC_EQL,  KC_NO,   KC_BSPC, KC_HOME,
  ...
  [_L3] = LAYOUT(
    ...
    _______,  BL_TOGG, BL_STEP, BL_UP,  BL_DOWN,  KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,    KC_NO,    KC_NO,    KC_NO,   KC_NO,   KC_NO,
...
layer_state_t layer_state_set_user(layer_state_t state) {
  switch (get_highest_layer(state)) {
    case _L1:
      ...
      break;
    case _L2:
      rgblight_sethsv_noeeprom(148, 255, 255); /*azure*/
      break;
    case _L3:
