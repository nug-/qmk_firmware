...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_L0] = LAYOUT_all(
		...
		KC_LCTL,  KC_LGUI, KC_LALT,                            LT_L1SP,                            KC_RALT, KC_RCTL,          KC_LEFT, KC_DOWN, KC_RGHT),

	// Fn1 Layer
	[_L1] = LAYOUT_all(
		_______,  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_PSCR,
		KC_GRV,   _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_DEL,  KC_DEL,  KC_DEL,
		_______,  KC_PGUP, KC_UP,   KC_PGDN, _______, _______, _______, _______, KC_PGUP, _______, _______, _______, _______, KC_INS,           KC_INS,
		_______,  KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, _______, KC_HOME, KC_PGDN, KC_END,  _______, _______, _______,                   KC_PSCR,
	...
	[_L2] = LAYOUT_all(
		...
		KC_LSFT,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,                   KC_UP,
		KC_LCTL,  KC_NO,   KC_LALT,                            KC_SPC,                             KC_RALT, KC_RCTL,          KC_LEFT, KC_DOWN, KC_RGHT),
