#include QMK_KEYBOARD_H // layout for WT60-C (Kate)
...
[_L1] = LAYOUT_all(
	...
	_______,  KC_LEFT, KC_DOWN, KC_RGHT, KC_EJCT, _______, _______, KC_HOME, KC_PGDN, KC_END,  _______, _______, KC_PSCR,
...
[_L3] = LAYOUT_all(
	QK_BOOT, EF_DEC,  EF_INC,   H1_DEC,  H1_INC,  H2_DEC,  H2_INC,  KC_NO,   KC_NO,   KC_NO,   KC_NO,   BR_DEC,  BR_INC,  KC_NO,   KC_NO,
