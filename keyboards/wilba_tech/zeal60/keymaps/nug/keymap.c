...
[_L0] = LAYOUT_60_ansi_split_bs_rshift(
	    ...
	    TD(TCAP), KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT,
			KC_LSFT,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, RSFT_UA, LT_L1DE,
			KC_LCTL,  KC_LGUI, KC_LALT,                            LT_L1SP,                   KC_NO,   RALT_LA, RGUI_DA, RCTL_RA),
...
[_L1] = LAYOUT_60_ansi_split_bs_rshift(
			 ...
			 _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, _______, KC_HOME, KC_PGDN, KC_END,  _______, _______, _______,
			 _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_PGUP, _______,
			 _______, _______, _______,                            _______,                   KC_NO,   KC_HOME, KC_PGDN, KC_END),
...
[_L2] = LAYOUT_60_ansi_split_bs_rshift(
      ...
      KC_LCTL,  KC_NO,   KC_LALT,                            KC_SPC,                    KC_NO,   KC_LEFT, KC_DOWN, KC_RGHT),
...
[_L3] = LAYOUT_60_ansi_split_bs_rshift(
		  ...
		  KC_NO,    EF_INC,  H1_INC,  S1_INC,  H2_INC,  S2_INC,  BR_INC,  ES_INC,  KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,
	    _______,  EF_DEC,  H1_DEC,  S1_DEC,  H2_DEC,  S2_DEC,  BR_DEC,  ES_DEC,  KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,
