#include QMK_KEYBOARD_H // Layout for Matrix ME
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_L0]=LAYOUT_all(
		...
		KC_LSFT,  KC_NO,   KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, RSFT_UA,                   KC_UP,
	...
	[_L1]=LAYOUT_all(
		...
		_______,  KC_NO,   _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_PGUP,                   KC_PGUP,
