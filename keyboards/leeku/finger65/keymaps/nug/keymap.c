#include QMK_KEYBOARD_H // Layout for TX65
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_L0] = LAYOUT_all(
    ...
    TD(TCAP), KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_NUHS, KC_ENT,  KC_PGDN,
    KC_LSFT,  KC_NO,   KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_UP,   LT_L1DE,
    KC_LCTL,  KC_LGUI, KC_LALT,                   _______, LT_L1SP, _______,          KC_RALT, KC_RCTL,          KC_LEFT, KC_DOWN, KC_RGHT),
  ...
  [_L2] = LAYOUT_all(
    ...
    KC_LCTL,  KC_NO,   KC_LALT,                   KC_SPC,  KC_SPC,  KC_SPC,           KC_RALT, KC_RCTL,          KC_LEFT, KC_DOWN, KC_RGHT),
