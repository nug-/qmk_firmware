// Default layer for ProjectKB Alice (Tengu)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_L1] = LAYOUT_default(
    ...
    KC_HOME,  _______,  KC_PGUP, KC_UP,   KC_PGDN, _______, _______,        _______, _______, KC_PGUP, _______, _______, _______, _______, KC_INS,
  ...
  [_L3] = LAYOUT_default(
    KC_NO,    RESET,    KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,
...
void x_finished (qk_tap_dance_state_t *state, void *user_data) {
  ...
  switch (xtap_state.state) {
    ...
    case DOUBLE_TAP: /*toggle gaming layer*/
      layer_invert(2); 
      //writePin(INDICATOR_PIN_1, 1);
      break;
    case TRIPLE_TAP: /*toggle reset layer*/
      layer_invert(3); 
      //writePin(INDICATOR_PIN_2, 1);
      break;
  }
}
...
void x_reset (qk_tap_dance_state_t *state, void *user_data) {
  switch (xtap_state.state) {
    ...
    case SINGLE_HOLD:
      ...
      break;
    case DOUBLE_TAP: 
      //writePin(INDICATOR_PIN_1, 0);
      break;
    case TRIPLE_TAP: 
      //writePin(INDICATOR_PIN_2, 0);
      break;
  }
  xtap_state.state = 0;
}
