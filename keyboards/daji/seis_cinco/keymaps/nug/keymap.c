#include QMK_KEYBOARD_H // Layout for Daji Seis Cinco
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_L0] = LAYOUT_all(
    ...
    KC_LCTL,  KC_LGUI,  KC_LALT,                            LT_L1SP,                            TD(TALT),           KC_LEFT, KC_DOWN,          KC_RIGHT),
  ...
  [_L2] = LAYOUT_all(
    ...
    KC_LCTL,  KC_NO,    KC_LALT,                            KC_SPC,                             TD(TALT),           KC_LEFT, KC_DOWN,          KC_RIGHT),
