...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_L1] = LAYOUT_all(
    ...
    BL_BRTG,  KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, _______, KC_HOME, KC_PGDN, KC_END,  _______, _______, KC_NO,   KC_PSCR,
  ...
  [_L3] = LAYOUT_all(
    QK_BOOT,  BL_DOWN,  BL_UP,  BL_TOGG, BL_BRTG, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,
