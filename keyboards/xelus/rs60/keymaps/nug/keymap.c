...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_L1] = LAYOUT_60_ansi_split_bs_rshift(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          KC_RSFT, KC_PGUP, _______,
        _______, _______, _______,                   _______,                                     KC_HOME, KC_HOME, KC_PGDN, KC_END),
