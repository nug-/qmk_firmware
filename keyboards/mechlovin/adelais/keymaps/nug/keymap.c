...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_L0] = LAYOUT_all(
    ...
    KC_PGDN, TD(TCAP), KC_A, KC_S,    KC_D, KC_F,   KC_G,                   KC_H, KC_J,   KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT,
             KC_LSFT,        KC_Z,    KC_X, KC_C,   KC_V,  KC_B,            KC_B, KC_N,   KC_M,    KC_COMM, KC_DOT, LT_L1DE, KC_RSFT, KC_SLSH,
  ...
  [_L1] = LAYOUT_all(
    ...
    KC_HOME, KC_CAPS,  KC_PGUP, KC_UP,   KC_PGDN, KC_TRNS, KC_TRNS,                  KC_TRNS, KC_TRNS, KC_PGUP, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_INS,
    KC_END,  KC_TRNS,  KC_LEFT, KC_DOWN, KC_RGHT, KC_TRNS, KC_TRNS,                  KC_TRNS, KC_HOME, KC_PGDN, KC_END,  KC_TRNS, KC_UP,  KC_PSCR,
             KC_TRNS,           KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,         KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_LEFT, _______, KC_RGHT, KC_DOWN,
             KC_TRNS,           KC_TRNS,          KC_TRNS,          KC_TRNS,                  KC_TRNS,          KC_TRNS,                            KC_TRNS ),
  [_L2] = LAYOUT_all(
    KC_ESC,  KC_GRV,   KC_1, KC_2,    KC_3, KC_4,   KC_5,  KC_6,            KC_7, KC_8,   KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSPC, KC_BSPC,
    MACRO0,  KC_TAB,   KC_Q, KC_W,    KC_E, KC_R,   KC_T,                   KC_Y, KC_U,   KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_SLSH,
    MACRO1,  _______,  KC_A, KC_S,    KC_D, KC_F,   KC_G,                   KC_H, KC_J,   KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT,
             KC_LSFT,        KC_Z,    KC_X, KC_C,   KC_V,  KC_B,            KC_B, KC_N,   KC_M,    KC_COMM, KC_DOT,  KC_DEL,  KC_RSFT, KC_SLSH,
             KC_LCTL,        KC_LALT,       KC_SPC,        KC_SPC,                KC_SPC,          KC_RALT,                            KC_RCTL ),
  [_L3] = LAYOUT_all(
    KC_TRNS, QK_BOOT, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,         KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
