...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_L0] = LAYOUT_all(
    ...
    KC_LSFT,   KC_NO,   KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, LT_L1DE, RSFT_UA,                   KC_UP,
  ...
  [_L1] = LAYOUT_all(
    ...
    _______,   KC_NO,   _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_PGUP,                   KC_PGUP,
  ...
  [_L2] = LAYOUT_all(
    ...
    KC_LSFT,   KC_NO,   KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_DEL, KC_RSFT,                    KC_UP,
  ...
  [_L3] = LAYOUT_all(
    ...
    KC_NO,     RGB_TOG, RGB_VAI, KC_NO,   RGB_SAI, RGB_HUI, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,
    KC_NO,     RGB_RMOD,RGB_VAD, RGB_MOD, RGB_SAD, RGB_HUD, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,            KC_NO,   KC_NO,   KC_NO,
