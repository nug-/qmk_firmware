...
[_L0] = LAYOUT_all(
    ...
    KC_LCTRL, KC_LGUI, KC_LALT,                            LT_L1SP,                   RALT_LA, RALT_LA, RGUI_DA, RCTL_RA),
...
[_L1] = LAYOUT_all(
    ...
    KC_TRNS, KC_TRNS,  KC_TRNS,                            KC_TRNS,                   KC_HOME, KC_HOME, KC_PGDN, KC_END),
...
[_L2] = LAYOUT_all(
    ...
    KC_LCTRL, KC_NO,   KC_LALT,                            KC_SPC,                    KC_LEFT, KC_LEFT, KC_DOWN, KC_RGHT),
