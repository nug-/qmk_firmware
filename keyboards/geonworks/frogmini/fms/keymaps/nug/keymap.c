#include QMK_KEYBOARD_H // Layout for Noxary 260 (X60R)
...
[_L0] = LAYOUT_all(
    ...
    KC_LCTRL, KC_LGUI, KC_LALT,                            LT_L1SP,                   RALT_LA, RALT_LA, RGUI_DA, RCTL_RA, KC_NO),

[_L1] = LAYOUT_all(
    KC_GRV,  KC_F1,    KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_DEL,
    KC_CAPS, KC_PGUP,  KC_UP,   KC_PGDN, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_PGUP, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_INS,
    KC_TRNS, KC_LEFT,  KC_DOWN, KC_RGHT, KC_TRNS, KC_TRNS, KC_TRNS, KC_HOME, KC_PGDN, KC_END,  KC_TRNS, KC_TRNS, KC_NO,   KC_PSCR,
    KC_TRNS, KC_NO,    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_PGUP, KC_TRNS,
    KC_TRNS, KC_TRNS,  KC_TRNS,                            KC_TRNS,                   KC_HOME, KC_HOME, KC_PGDN, KC_END,  KC_NO),
...
[_L2] = LAYOUT_all(
    ...
    KC_LCTRL, KC_NO,   KC_LALT,                            KC_SPC,                    KC_LEFT, KC_LEFT, KC_DOWN, KC_RGHT, KC_NO),
